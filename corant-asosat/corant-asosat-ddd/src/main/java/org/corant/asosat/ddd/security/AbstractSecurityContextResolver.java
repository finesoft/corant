...
@WebListener
public abstract class AbstractSecurityContextResolver
    implements KeycloakJaxrsSecurityContextResolver, ServletRequestListener {
  ...
  @Override
  public SecurityContext resolve(KeycloakPrincipal<RefreshableKeycloakSecurityContext> principal,
      boolean isSecure, String authenticationScheme, Set<String> roles) {
    return dscHolder.put(doResolve(principal, isSecure, authenticationScheme, roles));
  }

  protected abstract DefaultSecurityContext doResolve(
