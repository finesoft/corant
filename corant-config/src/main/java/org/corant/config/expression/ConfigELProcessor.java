...
public class ConfigELProcessor {
  ...
  protected ELManager getElManager() {
    if (elManagers.get() == null) {
      ...
      elm.importClass(Lists.class.getName());
      elm.importClass(Sets.class.getName());
      elm.importClass(Iterables.class.getName());
      elm.importClass(Maps.class.getName());
      elm.importClass(Empties.class.getName());
