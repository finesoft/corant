...
set ADDITIONAL_SYSTEM_PROPERTIES=#ADDITIONAL_SYSTEM_PROPERTIES#
...
if NOT "%ADDITIONAL_SYSTEM_PROPERTIES%" == "" set CORANT_JVM_OPTS=%CORANT_JVM_OPTS% %ADDITIONAL_SYSTEM_PROPERTIES%

if exist "%CFG_DIR%\log4j2.xml" set CORANT_JVM_OPTS=%CORANT_JVM_OPTS% -Dlog4j.configurationFile="%CFG_DIR%\log4j2.xml"
