...
public interface WechatOAuthClient {
  ...
  @GET
  @Path("/auth")
  String authToken(@QueryParam("access_token") String token, @QueryParam("openid") String openId);
  ...
  String grantAccessToken(@QueryParam("appid") String appid, @QueryParam("secret") String secret,
  ...
  String refreshToken(@QueryParam("appid") String appid, @QueryParam("grant_type") String grantType,
  ...
  @GET
  @Path("/userinfo")
  String userInfo(@QueryParam("access_token") String token, @QueryParam("openid") String openId,
