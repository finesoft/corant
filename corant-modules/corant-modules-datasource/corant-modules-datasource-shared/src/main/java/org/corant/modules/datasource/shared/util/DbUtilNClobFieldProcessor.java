 ...
 */
public class DbUtilNClobFieldProcessor implements DbUtilBasicFieldProcessor {

  @Override
  public Object convert(ResultSet rs, int colIndex, Object... hints) throws SQLException {
    return toObject(rs.getNClob(colIndex), String.class);
  }

  @Override
  public boolean supports(String fieldName, int sqlFieldType, Object... hints) {
    return sqlFieldType == Types.NCLOB;
  }
