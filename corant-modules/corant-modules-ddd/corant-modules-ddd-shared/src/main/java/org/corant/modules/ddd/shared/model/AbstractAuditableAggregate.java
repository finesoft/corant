...
public abstract class AbstractAuditableAggregate extends AbstractAggregate {
  ...
  protected AbstractAuditableAggregate() {}

  protected AbstractAuditableAggregate(Stream<? extends Message> messageStream) {
    reinitialize(messageStream);
  }
  ...
  protected abstract void reinitialize(Stream<? extends Message> messageStream);
}
