 ...
 *
 * <p>
 * Class used to deserialize Javafx ObservableList objects.
 * <p>
...
public class FXObservableListDeserializer<T extends ObservableList<Object>>
  ...
  private static final long serialVersionUID = 8934743687116866746L;
  ...
  protected FXObservableListDeserializer(CollectionType type, TypeDeserializer typeDeser,
  ...
  public FXObservableListDeserializer<T> withResolved(TypeDeserializer typeDeser,
      JsonDeserializer<?> valueDeser) {
    return new FXObservableListDeserializer<>(_containerType, typeDeser, valueDeser);
  }
