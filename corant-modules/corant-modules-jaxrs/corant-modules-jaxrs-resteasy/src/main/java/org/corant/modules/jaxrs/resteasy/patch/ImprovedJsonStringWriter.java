 ...
 * <p>
 * Class use to improve org.jboss.resteasy.plugins.providers.StringTextStar for output standard JSON
 * string (wrap in double quotation).
 * <p>
...
public class ImprovedJsonStringWriter extends AbstractImprovedJsonWriter<String>
    implements AsyncMessageBodyWriter<String> {

  @Override
  public CompletionStage<Void> asyncWriteTo(String t, Class<?> type, Type genericType,
