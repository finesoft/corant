...
/**
 * Utility used by all annotations to lookup the {@link javax.cache.annotation.CacheResolver} and
 * {@link CacheKeyGenerator} for a given method.
 *
...
public class CacheLookupUtil extends AbstractCacheLookupUtil<InvocationContext> {
   ...
   *
   * @see
   * org.jsr107.ri.annotations.AbstractCacheLookupUtil#createCacheKeyInvocationContextImpl(javax.
   * cache.annotation.impl.StaticCacheKeyInvocationContext, java.lang.Object)
   */
  @SuppressWarnings({"rawtypes", "unchecked"})
  @Override
