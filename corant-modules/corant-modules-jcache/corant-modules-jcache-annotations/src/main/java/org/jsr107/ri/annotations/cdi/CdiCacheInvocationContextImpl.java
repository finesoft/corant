 ...
 * @since 1.0
 */
public class CdiCacheInvocationContextImpl<A extends Annotation>
    extends AbstractInternalCacheInvocationContext<InvocationContext, A> {
   ...
   */
  public CdiCacheInvocationContextImpl(StaticCacheInvocationContext<A> staticCacheInvocationContext,
   ...
   *
   * @see
   * org.jsr107.ri.annotations.AbstractInternalCacheInvocationContext#getMethod(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.jsr107.ri.annotations.AbstractInternalCacheInvocationContext#getParameters(java.lang.
   * Object)
   */
  @Override
   ...
   *
   * @see
   * org.jsr107.ri.annotations.AbstractInternalCacheInvocationContext#getTarget(java.lang.Object)
   */
  @Override
