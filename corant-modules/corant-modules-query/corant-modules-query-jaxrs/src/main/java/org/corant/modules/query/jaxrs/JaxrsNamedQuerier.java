 ...
 *
 * @author bingo 21:24:44
 */
public interface JaxrsNamedQuerier extends FetchableNamedQuerier {

  JaxrsNamedQueryClientConfig getClientConfig();
  ...
  class JaxrsQueryParameter {
    ...
    protected void postConstruct() {
      ...
      String[] pps = split(propagateHeaderNames, ",", true, true);
      if (isNotEmpty(pps)) {
        propagateHeaderNameFilter = emptyPredicate(false);
        for (String s : pps) {
