 ...
 */
public abstract class AbstractNamedQuerierBuilder<Q extends NamedQuerier>
    implements NamedQuerierBuilder<Q> {
  ...
  protected AbstractNamedQuerierBuilder(Query query, QueryHandler queryHandler,
