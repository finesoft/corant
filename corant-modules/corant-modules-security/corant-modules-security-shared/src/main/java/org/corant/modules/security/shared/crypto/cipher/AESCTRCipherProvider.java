 ...
 *
 */
public class AESCTRCipherProvider extends SymmetricCipherProvider {
  ...
  public AESCTRCipherProvider(byte[] key, int keyBitSize) {
    this(null, key, keyBitSize);
  }

  public AESCTRCipherProvider(String provider, byte[] key, int keyBitSize) {
