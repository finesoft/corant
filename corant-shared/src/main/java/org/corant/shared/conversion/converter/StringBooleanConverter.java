...
public class StringBooleanConverter extends AbstractConverter<String, Boolean> {
   ...
   * @param defaultValue
   */
  public StringBooleanConverter(Boolean defaultValue) {
    super(defaultValue);
  }
   ...
   */
  public StringBooleanConverter(Boolean defaultValue, boolean useNullValueIfErr,
      boolean useDefaultValueIfErr) {
    super(defaultValue, useNullValueIfErr, useDefaultValueIfErr);
  }

  public StringBooleanConverter(Boolean defaultValue, boolean useNullValueIfErr,
      boolean useDefaultValueIfErr, String[] trues, String[] falses) {
    this(defaultValue, useNullValueIfErr, useDefaultValueIfErr);
    if (trues != null) {
