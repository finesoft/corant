...
public class Chars {
  ...
  public static boolean isAsciiAlpha(final char c) {
    return isLowerAsciiAlpha(c) || isUpperAsciiAlpha(c);
  }
  ...
  public static boolean isAsciiAlphaOrNumeric(final int c) {
    return isAsciiAlphaOrNumeric((char) c);
  }
  ...
  public static boolean isLowerAsciiAlpha(final int c) {
    return isLowerAsciiAlpha((char) c);
  }
  ...
  public static boolean isUpperAsciiAlpha(final int c) {
    return isUpperAsciiAlpha((char) c);
  }
  ...
  public static boolean isZhNumeric(final char c) {
    return c == '一' || c == '二' || c == '三' || c == '四' || c == '五' || c == '六' || c == '七'
        || c == '八' || c == '九' || c == '零' || c == '壹' || c == '弌' || c == '贰' || c == '弍'
        || c == '叁' || c == '弎' || c == '肆' || c == '伍' || c == '陆' || c == '柒' || c == '捌'
        || c == '玖';
  }
