...
public @interface PuName {
  ...
  public static class PuLiteral extends AnnotationLiteral<PuName> implements PuName {
    ...
    private PuLiteral(String value) {
      this.value = value;
    }

    public static PuLiteral[] from(String... values) {
      return Arrays.stream(values).map(PuLiteral::of).toArray(PuLiteral[]::new);
    }

    public static PuLiteral of(String value) {
      return new PuLiteral(value);
    }
