...
/**
 * Every aggregate that extends AbstractAggregate when life cycle change then
 * will fire LifecycleEvent, the infrastructure service will listen this event
 * and do persist or remove the aggregate.
 *
