...
public interface MessageDispatcher {
   ...
   *
   */
  public static class MessageSenderImpl implements MessageDispatcher {
    ...
    public MessageSenderImpl(org.corant.suites.jms.shared.annotation.MessageDispatch mpl) {
